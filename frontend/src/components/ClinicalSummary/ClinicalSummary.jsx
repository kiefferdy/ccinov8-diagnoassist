...
const ClinicalSummary = () => {
  ...
  const [selectedView, setSelectedView] = useState('summary'); // 'summary', 'timeline', 'export'
        ...
        <div className="space-y-6">
          {events.map((event, index) => (
            <div key={index} className="flex items-start">
              <div className={`flex-shrink-0 w-10 h-10 rounded-full bg-${event.color}-100 flex items-center justify-center`}>
              ...
              {index < events.length - 1 && (
                <div className="absolute left-5 mt-10 w-0.5 h-12 bg-gray-200"></div>
              )}
            </div>
          ))}
        </div>
        ...
        {selectedView === 'summary' ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Complete Clinical Summary</h3>
              <button
                onClick={handleCopyToClipboard}
                className={`flex items-center space-x-1 px-3 py-1.5 ${
                  copySuccess ? 'text-green-600 bg-green-50' : 'text-gray-600 hover:text-gray-700 hover:bg-gray-50'
            ...
            <textarea
              ...
              onChange={(e) => {
                ...
                updatePatientData('clinicalSummary', e.target.value);
              }}
              rows={25}
              ...
              placeholder="Clinical summary is being generated..."
            />
          </div>
        ) : selectedView === 'timeline' ? (
          renderTimeline()
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                onClick={exportPDF}
                className="flex items-center justify-center p-4 border-2 border-gray-300 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group"
              >
                <Download className="w-6 h-6 text-gray-600 group-hover:text-gray-800 mr-3" />
                <div className="text-left">
                  <p className="font-medium text-gray-900">Export as PDF</p>
                  <p className="text-sm text-gray-600">Download complete patient report</p>
                </div>
              </button>
              ...
              <button
                ...
                className="flex items-center justify-center p-4 border-2 border-gray-300 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group"
              >
                <Printer className="w-6 h-6 text-gray-600 group-hover:text-gray-800 mr-3" />
                <div className="text-left">
              ...
              <button
                ...
                className="flex items-center justify-center p-4 border-2 border-gray-300 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group"
              >
                <Mail className="w-6 h-6 text-gray-600 group-hover:text-gray-800 mr-3" />
                <div className="text-left">
                  <p className="font-medium text-gray-900">Email Report</p>
                  <p className="text-sm text-gray-600">Send to patient or colleague</p>
                </div>
              </button>
              ...
              <button
                ...
                className="flex items-center justify-center p-4 border-2 border-gray-300 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group"
              >
                <Share2 className="w-6 h-6 text-gray-600 group-hover:text-gray-800 mr-3" />
                <div className="text-left">
                  <p className="font-medium text-gray-900">Share Options</p>
                  <p className="text-sm text-gray-600">Additional sharing methods</p>
                </div>
              </button>
            </div>
