...
import { 
  Activity, Users, Clock, Plus, Calendar,
  FileText, AlertCircle, CheckCircle, 
  Stethoscope, Sparkles, ChevronRight, Sun,
  Coffee, Moon, UserCheck, Award, 
  StickyNote, X, Zap,
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/50 to-violet-50/50 animate-fadeIn">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="lg:flex lg:gap-8">
            ...
            {/* Right Column - Enhanced Recent Patients */}
            <section
              ref={rightRef}
              className="flex-1 flex flex-col min-h-0 rounded-3xl shadow-xl bg-white/90 border border-white/20 hover-lift lg:self-start"
              style={{ minHeight: '400px' }}
            >
              <header className="p-6 border-b border-gray-200 flex-shrink-0 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-3xl">
                <div className="flex items-center justify-between">
              ...
              <footer className="flex-shrink-0 flex flex-col items-center justify-center p-4 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-blue-50 rounded-b-3xl">
